/* ==========================================================================
   ...
   3. La navigation fluide (smooth scroll) via les liens de la barre-navigation
...
/* ==========================================================================
   ...
   Quand l'utilisateur clique sur un lien de la barre-navigation, au lieu de sauter
   directement à la section, on fait défiler la page doucement.
   ========================================================================== */

var liensNavigation = document.querySelectorAll('.lien-navigation');
...
var fleche = document.querySelector('.accueil-fleche-bas');
...
window.addEventListener('load', function () {
    setTimeout(function () {
        var indicationGlobe = document.querySelector('.indication-globe');
        if (indicationGlobe) {
